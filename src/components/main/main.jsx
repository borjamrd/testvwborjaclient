      ...
      <div className="cars-section">
        ...
        {car.filter((item, idx) => idx <24).map((item)=>(
            <div className="eachcar">
                ...
                <a target='_blank' href={item.carLocationLink}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin-map-fill" viewBox="0 0 16 16">
            ...
            <button onClick={sendEmail}>Me interesa</button>
              <button onClick={()=> navigate(`/${item.carNameParams}`)}>Más información</button>
            </div>
